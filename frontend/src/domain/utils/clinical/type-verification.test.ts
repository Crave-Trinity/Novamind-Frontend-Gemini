...
describe("Clinical type verification", () => {
  ...
  describe("verifyPatient", () => {
    ...
    it("verifies arrays of clinical data", () => {
      const patientWithArrays = {
        ...
        firstName: "John",
        lastName: "Smith",
        symptoms: [{ id: "symptom1", name: "Headache", severity: 3 }],
        diagnoses: [
          {
            id: "diagnosis1",
            name: "Migraine",
  ...
  describe("assertion functions", () => {
    ...
    it("assertPatient passes for valid Patient", () => {
      ...
      expect(() =>
        clinicalTypeVerifier.assertPatient(validPatient),
      ).not.toThrow();
    });
    ...
    it("assertPatient throws for invalid Patient", () => {
      ...
      expect(() => clinicalTypeVerifier.assertPatient(invalidPatient)).toThrow(
        TypeVerificationError,
      );
    });
  });
