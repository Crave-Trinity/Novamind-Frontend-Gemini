...
describe("Shared type verification", () => {
  describe("TypeVerificationError", () => {
    it("formats error message correctly", () => {
      const error = new TypeVerificationError(
        "Invalid type",
        "string",
        "number",
        "user.name",
  ...
  describe("verifyArray", () => {
    ...
    it("verifies array items with provided verifier", () => {
      const result = typeVerifier.verifyArray([1, 2, 3], (item) =>
  ...
  describe("assertion functions", () => {
    ...
    it("assertString throws for non-strings", () => {
      expect(() => typeVerifier.assertString(42)).toThrow(
    ...
    it("assertNumber throws for non-numbers", () => {
      expect(() => typeVerifier.assertNumber("42")).toThrow(
        TypeVerificationError,
      );
    });
    ...
    it("assertBoolean throws for non-booleans", () => {
      expect(() => typeVerifier.assertBoolean("true")).toThrow(
        TypeVerificationError,
      );
    });
    ...
    it("assertArray throws for non-arrays", () => {
      expect(() => typeVerifier.assertArray("not an array")).toThrow(
        TypeVerificationError,
      );
    });
    ...
    it("assertObject throws for non-objects", () => {
      expect(() => typeVerifier.assertObject(null)).toThrow(
        TypeVerificationError,
      );
    });
  });
