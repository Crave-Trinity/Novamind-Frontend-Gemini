...
export const ContributingFactorValidator = {
  ...
  isValid: (obj: unknown): obj is ContributingFactor => {
    ...
    const validCategories = [
      'demographic', 'clinical', 'psychological', 'social',
      'environmental', 'neurobiological'
    ];
    const hasValidCategory = typeof factor.category === 'string' && 
    ...
    const hasValidModifiability = typeof factor.modifiability === 'string' && 
    ...
    const hasValidTemporalRelevance = typeof factor.temporalRelevance === 'string' && 
...
export const ProtectiveFactorValidator = {
  ...
  isValid: (obj: unknown): obj is ProtectiveFactor => {
    ...
    const hasValidStrengthLevel = typeof factor.strengthLevel === 'string' && 
    ...
    const hasValidTemporalStability = typeof factor.temporalStability === 'string' && 
