...
describe('Risk type definitions', () => {
  ...
  it('RiskAssessment has correct structure', () => {
    ...
    expectTypeOf<RiskAssessment>().toHaveProperty('assessmentType')
    ...
    expectTypeOf<RiskAssessment>().toHaveProperty('temporalTrend')
      .toEqualTypeOf<"increasing" | "decreasing" | "stable" | "fluctuating">();
    expectTypeOf<RiskAssessment>().toHaveProperty('contributingFactors').toEqualTypeOf<ContributingFactor[]>();
    expectTypeOf<RiskAssessment>().toHaveProperty('protectiveFactors').toEqualTypeOf<ProtectiveFactor[]>();
    expectTypeOf<RiskAssessment>().toHaveProperty('neuralCorrelates').toEqualTypeOf<NeuralRiskCorrelate[]>();
  ...
  it('DomainRisk has correct structure', () => {
    expectTypeOf<DomainRisk>().toHaveProperty('domain')
      .toEqualTypeOf<"suicide" | "self_harm" | "harm_to_others" | "psychosis" | 
                       "substance_use" | "functional_decline" | "treatment_resistance" | 
    ...
    expectTypeOf<DomainRisk>().toHaveProperty('urgency')
  ...
  it('ContributingFactor has correct structure', () => {
    ...
    expectTypeOf<ContributingFactor>().toHaveProperty('category')
      .toEqualTypeOf<"demographic" | "clinical" | "psychological" | "social" | 
                       "environmental" | "neurobiological">();
    expectTypeOf<ContributingFactor>().toHaveProperty('impactWeight').toEqualTypeOf<number>();
    expectTypeOf<ContributingFactor>().toHaveProperty('modifiability')
      .toEqualTypeOf<"non-modifiable" | "partially-modifiable" | "modifiable">();
    expectTypeOf<ContributingFactor>().toHaveProperty('temporalRelevance')
  ...
  it('ProtectiveFactor has correct structure', () => {
    ...
    expectTypeOf<ProtectiveFactor>().toHaveProperty('category')
      .toEqualTypeOf<"clinical" | "psychological" | "social" | "environmental" | "neurobiological">();
    expectTypeOf<ProtectiveFactor>().toHaveProperty('strengthLevel')
      .toEqualTypeOf<"minimal" | "moderate" | "strong">();
    expectTypeOf<ProtectiveFactor>().toHaveProperty('temporalStability')
  ...
  it('RiskVisualizationSettings has correct structure', () => {
    ...
    expectTypeOf<RiskVisualizationSettings>().toHaveProperty('visualizationMode')
      .toEqualTypeOf<"heatmap" | "discrete" | "gradient">();
    expectTypeOf<RiskVisualizationSettings>().toHaveProperty('temporalResolution')
      .toEqualTypeOf<"daily" | "weekly" | "monthly" | "quarterly" | "yearly">();
    expectTypeOf<RiskVisualizationSettings>().toHaveProperty('showConfidenceIntervals')
