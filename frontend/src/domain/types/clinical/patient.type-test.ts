...
import { Patient, PatientDemographics, Diagnosis, Symptom, Medication } from './patient';
...
describe('Patient type definitions', () => {
  ...
  it('PatientDemographics has correct properties', () => {
    ...
    expectTypeOf<PatientDemographics>().toHaveProperty('biologicalSex')
      .toEqualTypeOf<"male" | "female" | "other">();
    expectTypeOf<PatientDemographics>().toHaveProperty('anonymizationLevel')
  ...
  it('Symptom has correct structure', () => {
    ...
    expectTypeOf<Symptom>().toHaveProperty('category')
