...
describe("Treatment type definitions", () => {
  ...
  it("TreatmentResponseRequest has correct structure", () => {
    ...
    expectTypeOf<TreatmentResponseRequest>()
      .toHaveProperty("genetic_data")
      .toBeNullable();
    expectTypeOf<TreatmentResponseRequest>()
      .toHaveProperty("biomarker_data")
      .toBeNullable();
    expectTypeOf<TreatmentResponseRequest>()
      .toHaveProperty("neuroimaging_features")
      .toBeNullable();
  });

  it("TreatmentDetails has correct structure and nested properties", () => {
    expectTypeOf<TreatmentDetails>()
      .toHaveProperty("medication")
      .toBeNullable();
    expectTypeOf<TreatmentDetails>()
      .toHaveProperty("psychotherapy")
      .toBeNullable();
    expectTypeOf<TreatmentDetails>()
      .toHaveProperty("neuromodulation")
      .toBeNullable();
    expectTypeOf<TreatmentDetails>()
      .toHaveProperty("neurofeedback")
      .toBeNullable();
    expectTypeOf<TreatmentDetails>().toHaveProperty("lifestyle").toBeNullable();
    expectTypeOf<TreatmentDetails>()
      .toHaveProperty("combination")
      .toBeNullable();
    ...
    expectTypeOf<
      NonNullable<TreatmentDetails["psychotherapy"]>["type"]
    >().toEqualTypeOf<
      | "cbt"
      | "dbt"
      | "psychodynamic"
    ...
    expectTypeOf<
      NonNullable<TreatmentDetails["neuromodulation"]>["type"]
  ...
  it("ClinicalPredictionData has correct structure", () => {
    ...
    expectTypeOf<ClinicalPredictionData>()
      .toHaveProperty("previousTreatmentResponses")
      .toBeArray();
    expectTypeOf<ClinicalPredictionData>()
    ...
    expectTypeOf<ClinicalPredictionData>()
      .toHaveProperty("substanceUse")
      .toEqualTypeOf<boolean>();
  });

  it("GeneticPredictionData has correct structure", () => {
    expectTypeOf<GeneticPredictionData>()
      .toHaveProperty("metabolizerStatus")
      .toBeNullable();
    expectTypeOf<GeneticPredictionData>()
      .toHaveProperty("pharmacodynamicMarkers")
      .toBeNullable();
    expectTypeOf<GeneticPredictionData>()
      .toHaveProperty("riskVariants")
      .toBeNullable();
    expectTypeOf<GeneticPredictionData>()
      .toHaveProperty("protectiveVariants")
      .toBeNullable();
    expectTypeOf<GeneticPredictionData>()
    ...
    expectTypeOf<
      NonNullable<GeneticPredictionData["metabolizerStatus"]>["cyp2d6"]
    >().toEqualTypeOf<
  ...
  it("BiomarkerData has correct structure", () => {
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("inflammatoryMarkers")
      .toBeNullable();
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("metabolicMarkers")
      .toBeNullable();
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("endocrineMarkers")
      .toBeNullable();
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("neurotransmitterMetabolites")
      .toBeNullable();
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("oxidativeStressMarkers")
      .toBeNullable();
    expectTypeOf<BiomarkerData>()
      .toHaveProperty("microbiomeProfile")
      .toBeNullable();
  });
