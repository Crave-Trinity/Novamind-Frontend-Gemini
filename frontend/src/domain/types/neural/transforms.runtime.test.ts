...
} from "@domain/types/neural/transforms.runtime";
...
describe("Neural Transforms runtime validators", () => {
  it("NeuralTransformValidator validates correct NeuralTransform objects", () => {
    ...
    expect(
      NeuralTransformValidator.isValid(invalidTransformMissingRequired),
    ).toBe(false);
    expect(NeuralTransformValidator.isValid(invalidTransformWrongRange)).toBe(
      false,
    );
  ...
  it("NeuralTransformBatchValidator validates correct NeuralTransformBatch objects", () => {
    ...
    expect(
      NeuralTransformBatchValidator.isValid(invalidBatchMissingRequired),
    ).toBe(false);
    expect(
      NeuralTransformBatchValidator.isValid(invalidBatchInvalidTransforms),
    ).toBe(false);
  ...
  it("NeuralTransformSequenceValidator validates correct NeuralTransformSequence objects", () => {
    ...
    expect(
      NeuralTransformSequenceValidator.isValid(invalidSequenceMissingRequired),
    ).toBe(false);
    expect(
      NeuralTransformSequenceValidator.isValid(invalidSequenceInvalidBatch),
    ).toBe(false);
    expect(
      NeuralTransformSequenceValidator.isValid(invalidSequenceNegativeDelay),
    ).toBe(false);
  ...
  it("NeuralTransformResultValidator validates correct NeuralTransformResult objects", () => {
    ...
    expect(
      NeuralTransformResultValidator.isValid(invalidResultMissingRequired),
    ).toBe(false);
    expect(
      NeuralTransformResultValidator.isValid(invalidResultInvalidMetrics),
    ).toBe(false);
    expect(
      NeuralTransformResultValidator.isValid(
        invalidResultInvalidPerformanceMetrics,
      ),
    ).toBe(false);
