...
describe('Neural Transforms type definitions', () => {
  it('NeuralTransform has correct structure', () => {
    ...
    expectTypeOf<NeuralTransform>().toHaveProperty('sourceTrigger')
  ...
  it('NeuralTransformBatch has correct structure', () => {
    ...
    expectTypeOf<NeuralTransformBatch>().toHaveProperty('transforms').toEqualTypeOf<NeuralTransform[]>();
    ...
    expectTypeOf<NeuralTransformBatch>().toHaveProperty('source')
  ...
  it('NeuralTransformSequence has correct structure', () => {
    ...
    expectTypeOf<NeuralTransformSequence['interRepetitionDelayMs']>().toEqualTypeOf<number | undefined>();
    ...
    expectTypeOf<NeuralTransformSequence['transformBatches'][number]>().toHaveProperty('batch').toEqualTypeOf<NeuralTransformBatch>();
    expectTypeOf<NeuralTransformSequence['transformBatches'][number]>().toHaveProperty('delayMs').toEqualTypeOf<number>();
  });
  ...
  it('NeuralTransformResult has correct structure', () => {
    ...
    expectTypeOf<NeuralTransformResult>().toHaveProperty('affectedRegions').toEqualTypeOf<string[]>();
    ...
    expectTypeOf<NonNullable<NeuralTransformResult['affectedMetrics']>[number]>().toHaveProperty('metricId').toEqualTypeOf<string>();
    expectTypeOf<NonNullable<NeuralTransformResult['affectedMetrics']>[number]>().toHaveProperty('previousValue').toEqualTypeOf<number>();
    expectTypeOf<NonNullable<NeuralTransformResult['affectedMetrics']>[number]>().toHaveProperty('newValue').toEqualTypeOf<number>();
    expectTypeOf<NonNullable<NeuralTransformResult['affectedMetrics']>[number]>().toHaveProperty('percentChange').toEqualTypeOf<number>();
    
    // Test nested performanceMetrics structure
    expectTypeOf<NonNullable<NeuralTransformResult['performanceMetrics']>>().toHaveProperty('processingTimeMs').toEqualTypeOf<number>();
    expectTypeOf<NonNullable<NeuralTransformResult['performanceMetrics']>>().toHaveProperty('computationalIntensity')
