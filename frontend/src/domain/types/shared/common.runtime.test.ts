...
describe("Common Shared Types runtime validators", () => {
  ...
  describe("ColorRGBAValidator", () => {
    it("validates valid ColorRGBA objects", () => {
      expect(ColorRGBAValidator.isValid({ r: 255, g: 0, b: 0, a: 1 })).toBe(
        true,
      );
      expect(ColorRGBAValidator.isValid({ r: 0, g: 255, b: 0, a: 0.5 })).toBe(
        true,
      );
      expect(ColorRGBAValidator.isValid({ r: 0, g: 0, b: 255, a: 0 })).toBe(
        true,
      );
    });
    ...
    it("rejects invalid ColorRGBA objects", () => {
      ...
      expect(ColorRGBAValidator.isValid({ r: 255, g: 0, b: 0, a: 1.1 })).toBe(
        false,
      );
      expect(ColorRGBAValidator.isValid({ r: 255, g: 0, b: 0, a: -0.1 })).toBe(
        false,
      );
      expect(ColorRGBAValidator.isValid({ r: 255, g: 0, b: 0, a: "1" })).toBe(
        false,
  ...
  describe("DimensionsValidator", () => {
    it("validates valid Dimensions objects", () => {
      expect(DimensionsValidator.isValid({ width: 100, height: 200 })).toBe(
        true,
      );
      expect(DimensionsValidator.isValid({ width: 0, height: 0 })).toBe(true);
      expect(DimensionsValidator.isValid({ width: 10.5, height: 20.5 })).toBe(
        true,
      );
    });
    ...
    it("rejects invalid Dimensions objects", () => {
      ...
      expect(DimensionsValidator.isValid({ width: -1, height: 200 })).toBe(
        false,
      );
      expect(DimensionsValidator.isValid({ width: 100, height: -1 })).toBe(
        false,
      );
      expect(DimensionsValidator.isValid({ width: "100", height: 200 })).toBe(
        false,
