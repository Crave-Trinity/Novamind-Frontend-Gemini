...
describe("Brain Visualization runtime validators", () => {
  ...
  it("VisualizationSettingsValidator validates correct VisualizationSettings objects", () => {
    ...
    expect(
      VisualizationSettingsValidator.isValid(defaultVisualizationSettings),
    ).toBe(true);
  ...
  it("ThemeSettingsValidator validates correct ThemeSettings objects", () => {
    ...
    expect(ThemeSettingsValidator.isValid(visualizationThemes.clinical)).toBe(
      true,
    );
    expect(ThemeSettingsValidator.isValid(visualizationThemes.dark)).toBe(true);
    expect(
      ThemeSettingsValidator.isValid(visualizationThemes["high-contrast"]),
    ).toBe(true);
  ...
  it("BrainVisualizationStateValidator validates correct BrainVisualizationState objects", () => {
    ...
    expect(BrainVisualizationStateValidator.isValid(invalidErrorState)).toBe(
      false,
    );
  ...
  it("ProcessedNeuralConnectionValidator validates correct ProcessedNeuralConnection objects", () => {
    ...
    expect(ProcessedNeuralConnectionValidator.isValid(validConnection)).toBe(
      true,
    );
    expect(ProcessedNeuralConnectionValidator.isValid(invalidConnection)).toBe(
      false,
    );
