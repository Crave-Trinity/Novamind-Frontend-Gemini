...
describe('Brain Visualization type definitions', () => {
  ...
  it('VisualizationSettings has correct structure', () => {
    ...
    expectTypeOf<VisualizationSettings>().toHaveProperty('cameraPosition').toEqualTypeOf<[number, number, number]>();
    ...
    expectTypeOf<VisualizationSettings>().toHaveProperty('showConnections').toEqualTypeOf<boolean>();
    expectTypeOf<VisualizationSettings>().toHaveProperty('connectionOpacity').toEqualTypeOf<number>();
    expectTypeOf<VisualizationSettings>().toHaveProperty('connectionThickness').toEqualTypeOf<number>();
    expectTypeOf<VisualizationSettings>().toHaveProperty('connectionColorMapping')
    ...
    expectTypeOf<VisualizationSettings>().toHaveProperty('enablePulsation').toEqualTypeOf<boolean>();
    
    // Rendering effects
    expectTypeOf<VisualizationSettings>().toHaveProperty('renderQuality')
    ...
    expectTypeOf<VisualizationSettings>().toHaveProperty('activityColorScale').toEqualTypeOf<string[]>();
    
    // Performance settings
    expectTypeOf<VisualizationSettings>().toHaveProperty('maxVisibleRegions').toEqualTypeOf<number>();
    expectTypeOf<VisualizationSettings>().toHaveProperty('levelOfDetail')
  ...
  it('BrainVisualizationState has correct discriminated union', () => {
    ...
    expectTypeOf<BrainVisualizationState>().toMatchTypeOf<{ status: "loading" }>();
    
    // Test the error state
    expectTypeOf<BrainVisualizationState>().toMatchTypeOf<{ status: "error"; error: Error }>();
  ...
  it('ProcessedBrainData has correct structure', () => {
    expectTypeOf<ProcessedBrainData>().toHaveProperty('regions').toEqualTypeOf<ProcessedBrainRegion[]>();
    expectTypeOf<ProcessedBrainData>().toHaveProperty('connections').toEqualTypeOf<ProcessedNeuralConnection[]>();
    expectTypeOf<ProcessedBrainData>().toHaveProperty('centerOfMass').toEqualTypeOf<[number, number, number]>();
    ...
    // Stats object
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('regionCount').toEqualTypeOf<number>();
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('connectionCount').toEqualTypeOf<number>();
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('averageActivity').toEqualTypeOf<number>();
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('maxActivity').toEqualTypeOf<number>();
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('minActivity').toEqualTypeOf<number>();
    expectTypeOf<ProcessedBrainData['stats']>().toHaveProperty('densityScore').toEqualTypeOf<number>();
  });

  it('ProcessedBrainRegion has correct structure', () => {
    expectTypeOf<ProcessedBrainRegion>().toHaveProperty('renderPosition').toEqualTypeOf<[number, number, number]>();
    ...
    expectTypeOf<ProcessedBrainRegion>().toHaveProperty('normalizedActivity').toEqualTypeOf<number>();
  });

  it('ProcessedNeuralConnection has correct structure', () => {
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('sourcePosition').toEqualTypeOf<[number, number, number]>();
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('targetPosition').toEqualTypeOf<[number, number, number]>();
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('renderColor').toEqualTypeOf<string>();
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('renderThickness').toEqualTypeOf<number>();
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('renderOpacity').toEqualTypeOf<number>();
    ...
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('isHighlighted').toEqualTypeOf<boolean>();
    expectTypeOf<ProcessedNeuralConnection>().toHaveProperty('normalizedStrength').toEqualTypeOf<number>();
  });
});
