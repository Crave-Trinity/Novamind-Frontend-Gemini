...
describe('Patient Model type definitions', () => {
  it('PatientDemographics has correct structure', () => {
    ...
    expectTypeOf<PatientDemographics>().toHaveProperty('biologicalSex').toEqualTypeOf<'male' | 'female' | 'other'>();
  ...
  it('Symptom has correct structure', () => {
    ...
    expectTypeOf<Symptom>().toHaveProperty('frequency').toEqualTypeOf<'rare' | 'occasional' | 'frequent' | 'constant'>();
  ...
  it('PatientModel has correct structure', () => {
    ...
    expectTypeOf<PatientModel>().toHaveProperty('demographics').toEqualTypeOf<PatientDemographics>();
    ...
    expectTypeOf<PatientModel>().toHaveProperty('treatmentResponses').toEqualTypeOf<TreatmentResponse[]>();
