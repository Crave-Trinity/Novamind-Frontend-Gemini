...
describe("Patient Model type definitions", () => {
  it("PatientDemographics has correct structure", () => {
    ...
    expectTypeOf<PatientDemographics>()
      .toHaveProperty("heightCm")
      .toBeNullable();
    expectTypeOf<PatientDemographics>()
      .toHaveProperty("weightKg")
      .toBeNullable();
    expectTypeOf<PatientDemographics>()
      .toHaveProperty("handedness")
      .toBeNullable();
    expectTypeOf<PatientDemographics>()
      .toHaveProperty("ethnicity")
      .toBeNullable();
  });

  it("ClinicalHistory has correct structure", () => {
    expectTypeOf<ClinicalHistory>()
      .toHaveProperty("primaryDiagnosis")
      .toEqualTypeOf<string>();
    expectTypeOf<ClinicalHistory>()
      .toHaveProperty("secondaryDiagnoses")
      .toBeNullable();
    expectTypeOf<ClinicalHistory>()
      .toHaveProperty("diagnosisDate")
      .toBeNullable();
    expectTypeOf<ClinicalHistory>()
      .toHaveProperty("familyHistory")
      .toBeNullable();
    expectTypeOf<ClinicalHistory>()
      .toHaveProperty("previousTreatments")
      .toBeNullable();
  ...
  it("TreatmentResponse has correct structure", () => {
    expectTypeOf<TreatmentResponse>()
      .toHaveProperty("treatmentId")
      .toEqualTypeOf<string>();
    expectTypeOf<TreatmentResponse>()
      .toHaveProperty("treatmentName")
      .toEqualTypeOf<string>();
    expectTypeOf<TreatmentResponse>()
      .toHaveProperty("startDate")
      .toEqualTypeOf<Date>();
    ...
    expectTypeOf<TreatmentResponse>()
      .toHaveProperty("effectivenesRating")
      .toEqualTypeOf<number>();
    expectTypeOf<TreatmentResponse>()
  ...
  it("PatientModel has correct structure", () => {
    ...
    expectTypeOf<PatientModel>()
      ...
      .toEqualTypeOf<Date>();
    expectTypeOf<PatientModel>()
      .toHaveProperty("contactInformation")
      .toBeObject();
    expectTypeOf<PatientModel>()
      .toHaveProperty("demographics")
      .toEqualTypeOf<PatientDemographics>();
    expectTypeOf<PatientModel>()
      .toHaveProperty("clinicalHistory")
      .toEqualTypeOf<ClinicalHistory>();
    expectTypeOf<PatientModel>()
      .toHaveProperty("medications")
      .toEqualTypeOf<Medication[]>();
    expectTypeOf<PatientModel>()
      .toHaveProperty("symptoms")
      .toEqualTypeOf<Symptom[]>();
    expectTypeOf<PatientModel>()
