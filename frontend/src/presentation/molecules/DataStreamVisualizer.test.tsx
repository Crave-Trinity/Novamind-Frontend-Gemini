...
import { DataStreamVisualizer, DataStream, DataPoint } from "@presentation/molecules/DataStreamVisualizer"; // Import types
...
vi.mock('@react-three/drei', async (importOriginal) => {
  ...
  return {
    ...
    Billboard: (props: any) => <group {...props} data-testid="mock-billboard" />, // Mock Billboard
  };
});
...
const mockConnections: NeuralConnection[] = createMockNeuralConnections(mockRegions, 8);
...
const mockProps = {
  ...
  streamData: { // This prop seems unused based on component code, but keep for now if needed elsewhere
