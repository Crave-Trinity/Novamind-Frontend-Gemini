...
const createValidMockBrainModel = (): BrainModel => ({
  ...
  connections: [
    ...
    { id: 'c1', sourceId: 'r1', targetId: 'r2', strength: 0.8, type: 'excitatory', isActive: true, color: '#FFFFFF' },
  ],
...
describe('useBrainModel Runtime Validation', () => {
  describe('validateBrainModelData', () => {
    ...
    it('should return Err for non-object input', () => {
      ...
      expect((result.val as Error).message).toContain('Invalid BrainModelData: Data does not conform to the BrainModel structure.');
    });
