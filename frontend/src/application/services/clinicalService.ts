        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this patient's risk assessment",
                ),
              );
            case 500:
              return failure(
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this patient's treatment predictions",
                ),
              );
            case 500:
              return failure(
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this patient's symptoms",
                ),
              );
            case 500:
              return failure(
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this patient's diagnoses",
                ),
              );
            case 500:
              return failure(
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this patient's treatments",
                ),
              );
            case 500:
              return failure(
      ...
      if (axios.isAxiosError(error)) {
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error("Insufficient permissions to update this symptom"),
              );
            case 500:
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to access this algorithm explanation",
                ),
              );
            case 500:
              return failure(
                new Error(
                  "Server error while generating algorithm explanation",
                ),
              );
            default:
              return failure(new Error(data.message || `API error: ${status}`));
        ...
        if (error.response) {
          ...
          switch (status) {
            ...
            case 403:
              return failure(
                new Error(
                  "Insufficient permissions to generate projections for this patient",
                ),
              );
            case 500:
              return failure(
                new Error("Server error while generating temporal projections"),
              );
            default:
              return failure(new Error(data.message || `API error: ${status}`));
          }
