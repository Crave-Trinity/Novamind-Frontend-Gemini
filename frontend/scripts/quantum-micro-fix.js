 ...
 */
function createDirectThreeMock() {
 ...
 */
function fixComponentTest(component) {
 ...
 */
function createMinimalVitestConfig() {
 ...
 */
function executeComponentTest(componentName) {
