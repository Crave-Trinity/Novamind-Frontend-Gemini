...
function ensureDirectoryExists(dirPath: any): any {
...
function removeUnusedImportsAndVariables(filePath: any): any {
...
function fixNullableAccess(filePath: any): any {
  if (!fs.existsSync(filePath)) {
    return false;
  }
...
function addThemeTypeGuard(filePath: any): any {
  if (!fs.existsSync(filePath)) {
    return false;
  }
...
function isValidTheme(theme: string: any): any: theme is keyof typeof visualSettings {
...
function createThreeJsTypes(): any {
