...
function fixAppComponent() {
  ...
  if (fs.existsSync(appPath)) {
    ...
    if (!content.includes('export default App')) {
      ...
      if (content.includes('export function App(') || content.includes('export const App =')){
...
function fixThemeProvider() {
  ...
  if (fs.existsSync(themeProviderPath)) {
    ...
    if (!content.includes('export default ThemeProvider')) {
      ...
      if (content.includes('export function ThemeProvider(') || content.includes('export const ThemeProvider =')){
        content = content.replace(
...
function processComponentExports() {
...
function fixReactQueryProviderInTests() {
