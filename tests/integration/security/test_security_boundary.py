...
from app.infrastructure.security.rbac.role_manager import RoleManager, Role, Permission
...
class TestSecurityBoundary:
    ...
    def test_complete_auth_flow(self, security_components):
        ...
        assert role_manager.has_permission(token_data.role, Permission.VIEW_OWN_PROFILE)
    ...
    def test_provider_access_scope(self, security_components):
        ...
        assert role_manager.has_permission(provider_data.role, Permission.VIEW_PATIENT_MEDICAL_RECORDS)
        
        # Verify patient cannot access other patients' medical records
        assert not role_manager.has_permission(patient_data.role, Permission.VIEW_PATIENT_MEDICAL_RECORDS)
