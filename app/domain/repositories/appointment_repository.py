...
class AppointmentRepository(ABC):
    ...
    @abstractmethod
    async def list_by_patient(self, patient_id: UUID, limit: int = 100, offset: int = 0) -> List[Appointment]:
        """
    ...
    @abstractmethod
    async def list_by_provider(self, provider_id: UUID, limit: int = 100, offset: int = 0) -> List[Appointment]:
        """
    ...
    async def list_by_date_range(self, start_date: datetime, end_date: datetime, 
                               provider_id: Optional[UUID] = None) -> List[Appointment]:
        """
    ...
    @abstractmethod
    async def list_by_status(self, status: AppointmentStatus, 
                           limit: int = 100, offset: int = 0) -> List[Appointment]:
        """
    ...
    @abstractmethod
    async def get_upcoming_appointments(self, provider_id: Optional[UUID] = None, 
                                      days: int = 7) -> List[Appointment]:
        """
