...
class ClinicalNoteRepository(ABC):
    ...
    @abstractmethod
    async def list_by_patient(self, patient_id: UUID, limit: int = 100, offset: int = 0) -> List[ClinicalNote]:
        """
    ...
    @abstractmethod
    async def list_by_provider(self, provider_id: UUID, limit: int = 100, offset: int = 0) -> List[ClinicalNote]:
        """
    ...
    @abstractmethod
    async def list_by_status(self, status: NoteStatus, 
                           limit: int = 100, offset: int = 0) -> List[ClinicalNote]:
        """
    ...
    @abstractmethod
    async def list_by_type(self, note_type: NoteType, 
                         limit: int = 100, offset: int = 0) -> List[ClinicalNote]:
        """
    ...
    async def list_by_date_range(self, start_date: datetime, end_date: datetime,
                               patient_id: Optional[UUID] = None) -> List[ClinicalNote]:
        """
    ...
    @abstractmethod
    async def search_by_content(self, query: str, patient_id: Optional[UUID] = None,
                              limit: int = 100, offset: int = 0) -> List[ClinicalNote]:
        """
