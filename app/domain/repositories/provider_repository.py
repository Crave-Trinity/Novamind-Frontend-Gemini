...
class ProviderRepository(ABC):
    ...
    @abstractmethod
    async def list_by_role(self, role: ProviderRole, limit: int = 100, offset: int = 0) -> List[Provider]:
        """
    ...
    @abstractmethod
    async def list_by_specialty(self, specialty: ProviderSpecialty, 
                              limit: int = 100, offset: int = 0) -> List[Provider]:
        """
    ...
    @abstractmethod
    async def list_accepting_patients(self, limit: int = 100, offset: int = 0) -> List[Provider]:
        """
    ...
    @abstractmethod
    async def search(self, query: str, limit: int = 100, offset: int = 0) -> List[Provider]:
        """
    ...
    @abstractmethod
    async def get_prescribers(self, limit: int = 100, offset: int = 0) -> List[Provider]:
        """
    ...
    @abstractmethod
    async def get_available_on_day(self, day_of_week: int, 
                                 limit: int = 100, offset: int = 0) -> List[Provider]:
        """
