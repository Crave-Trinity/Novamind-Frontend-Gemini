...
class MedicationRepository(ABC):
    ...
    @abstractmethod
    async def list_by_patient(self, patient_id: UUID, limit: int = 100, offset: int = 0) -> List[Medication]:
        """
    ...
    @abstractmethod
    async def list_by_provider(self, provider_id: UUID, limit: int = 100, offset: int = 0) -> List[Medication]:
        """
    ...
    @abstractmethod
    async def list_by_status(self, status: MedicationStatus, 
                           limit: int = 100, offset: int = 0) -> List[Medication]:
        """
    ...
    @abstractmethod
    async def list_by_refill_status(self, refill_status: RefillStatus, 
                                  limit: int = 100, offset: int = 0) -> List[Medication]:
        """
    ...
    @abstractmethod
    async def search_by_name(self, name: str, patient_id: Optional[UUID] = None,
                           limit: int = 100, offset: int = 0) -> List[Medication]:
        """
