...
from app.domain.exceptions import ValidationError, AuthorizationError, BusinessRuleViolationError
...
class AIAssistantService:
    ...
    async def generate_clinical_note_draft(self,
                                         provider_id: UUID,
                                         patient_id: UUID,
                                         appointment_id: UUID,
                                         note_context: Dict[str, Any]) -> Dict[str, Any]:
        """
        ...
        if not self._is_provider_authorized_for_patient(provider_id, patient_id):
            raise AuthorizationError(f"Provider {provider_id} is not authorized to access patient {patient_id}")
    ...
    async def analyze_medication_interactions(self,
                                           provider_id: UUID,
                                           patient_id: UUID,
                                           proposed_medications: List[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def generate_treatment_recommendations(self,
                                              provider_id: UUID,
                                              patient_id: UUID,
                                              diagnosis_codes: List[str],
                                              treatment_context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def generate_patient_education_material(self,
                                               provider_id: UUID,
                                               patient_id: UUID,
                                               topic: str,
                                               education_context: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    async def summarize_research_literature(self,
                                         provider_id: UUID,
                                         topic: str,
