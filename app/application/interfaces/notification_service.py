...
class NotificationService(ABC):
    ...
    @abstractmethod
    async def send_appointment_reminder(self, recipient_id: UUID, appointment_data: Dict[str, Any]) -> bool:
        """
    ...
    @abstractmethod
    async def send_secure_message(self, recipient_id: UUID, message_content: str, sender_id: UUID) -> bool:
        """
