...
class SymptomForecastingService:
    ...
    async def preprocess_patient_data(self, 
                                    patient_id: UUID,
    ...
    async def forecast_symptoms(self, 
        ...
        try:
            ...
            if preprocessed_data.shape[0] < 5:
                raise ValidationError("Insufficient time series data for forecasting (minimum 5 points required)")
    ...
    async def evaluate_treatment_impact(self, 
                                      patient_id: UUID,
        ...
        try:
            ...
            if baseline_preprocessed.shape[0] < 5:
                raise ValidationError("Insufficient baseline data for treatment impact evaluation")
    ...
    async def detect_symptom_patterns(self, 
        ...
        try:
            ...
            if preprocessed_data.shape[0] < 10:
                raise ValidationError("Insufficient time series data for pattern detection (minimum 10 points required)")
