...
from app.infrastructure.ml.symptom_forecasting.ensemble_model import SymptomEnsembleModel
...
class SymptomForecastingServiceImpl(SymptomForecastingService):
    ...
    async def generate_forecast(
        ...
        try:
            ...
            logger.error(f"Error generating forecast for patient {patient_id}: {str(e)}")
    ...
    async def analyze_symptom_patterns(
        ...
        """
        logger.info(f"Analyzing symptom patterns for patient {patient_id}, lookback: {lookback_days} days")
        ...
        try:
            ...
            logger.error(f"Error analyzing symptom patterns for patient {patient_id}: {str(e)}")
    ...
    async def detect_anomalies(
        ...
        try:
            ...
            logger.error(f"Error detecting anomalies for patient {patient_id}: {str(e)}")
