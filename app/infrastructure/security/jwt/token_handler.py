...
class JWTHandler:
    ...
    def __init__(self, 
        ...
        self.access_token_expire_minutes = (
            ...
            settings.security.JWT_ACCESS_TOKEN_EXPIRE_MINUTES
        )
    ...
    def create_access_token(self, 
        ...
        logger.info(f"Created access token for user: {user_id}, expires: {expire.isoformat()}")
    ...
    def refresh_token(self, token: str, extend_minutes: Optional[int] = None) -> str:
        ...
        return self.create_access_token(
            ...
            expires_delta=timedelta(minutes=extend_minutes or self.access_token_expire_minutes)
        )
