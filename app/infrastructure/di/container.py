...
from typing import Dict, Any, Optional, Callable, Type, TypeVar, Generic, cast
import inspect
...
from app.domain.repositories.digital_twin_repository import DigitalTwinRepositoryInterface
...
class DIContainer:
    ...
    def register(self, interface_type: Type[T], implementation_factory: Callable[[], T]) -> None:
        """
...
def get_container() -> DIContainer:
    ...
    container.register(DigitalTwinRepositoryInterface, lambda: DigitalTwinRepository(next(db_dependency())))
    container.register(PatientRepositoryInterface, lambda: PatientRepository(next(db_dependency())))
    ...
    container.register_scoped(DigitalTwinApplicationService, DigitalTwinApplicationService)
