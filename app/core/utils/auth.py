...
ROLE_PERMISSIONS = {
    Role.ADMIN: [
        Permission.VIEW_PATIENT, Permission.EDIT_PATIENT, Permission.CREATE_PATIENT, Permission.DELETE_PATIENT,
        Permission.VIEW_PROVIDER, Permission.EDIT_PROVIDER, Permission.CREATE_PROVIDER, Permission.DELETE_PROVIDER,
        Permission.VIEW_RECORD, Permission.EDIT_RECORD, Permission.CREATE_RECORD, Permission.DELETE_RECORD,
        Permission.VIEW_PRESCRIPTION, Permission.EDIT_PRESCRIPTION, Permission.CREATE_PRESCRIPTION, Permission.DELETE_PRESCRIPTION,
        Permission.MANAGE_USERS, Permission.MANAGE_SYSTEM, Permission.VIEW_AUDIT_LOGS,
        Permission.ACCESS_ANONYMIZED_DATA, Permission.RUN_ANALYTICS
    ],
    Role.PROVIDER: [
        Permission.VIEW_PATIENT, Permission.EDIT_PATIENT, Permission.CREATE_PATIENT,
        Permission.VIEW_PROVIDER,
        Permission.VIEW_RECORD, Permission.EDIT_RECORD, Permission.CREATE_RECORD,
        Permission.VIEW_PRESCRIPTION, Permission.EDIT_PRESCRIPTION, Permission.CREATE_PRESCRIPTION,
        Permission.ACCESS_ANONYMIZED_DATA, Permission.RUN_ANALYTICS
    ],
    Role.PATIENT: [
...
class AuthenticationService:
    ...
    def __init__(
        ...
        self.token_expire_minutes = token_expire_minutes or settings.security.JWT_ACCESS_TOKEN_EXPIRE_MINUTES
