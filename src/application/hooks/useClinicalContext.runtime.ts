...
function isNeuralActivationPattern(
  obj: unknown,
): obj is NeuralActivationPattern {
...
export function validateTreatmentResponsePredictionArray(
  ...
  if (!Array.isArray(data)) {
    return Err(
      new Error(
        "Invalid TreatmentResponsePrediction array: Input must be an array.",
      ),
    );
  }
 ...
 */
export function validateSymptomMappingArray(
  data: unknown,
): Result<SymptomNeuralMapping[], Error> {
  if (!Array.isArray(data)) {
    return Err(
      new Error("Invalid SymptomNeuralMapping array: Input must be an array."),
    );
  }
...
export function validateDiagnosisMappingArray(
  ...
  if (!Array.isArray(data)) {
    return Err(
      new Error(
        "Invalid DiagnosisNeuralMapping array: Input must be an array.",
      ),
    );
  }
...
export function validateTreatmentMappingArray(
  ...
  if (!Array.isArray(data)) {
    return Err(
      new Error(
        "Invalid TreatmentNeuralMapping array: Input must be an array.",
      ),
    );
  }
