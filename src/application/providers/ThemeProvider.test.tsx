...
describe('ThemeProvider', () => {
  ...
  beforeEach(() => {
    ...
    const mockMediaQueryListObject: {
        ...
        // Deprecated methods
        addListener: vi.fn((listener) => { mediaQueryChangeListener = listener; }),
        removeListener: vi.fn((listener) => { if (mediaQueryChangeListener === listener) { mediaQueryChangeListener = null;} }),
    };
    ...
    Object.defineProperty(window, 'matchMedia', {
      value: vi.fn().mockImplementation((query: string) => {
          ...
          return { matches: false, media: query, addEventListener: vi.fn(), removeEventListener: vi.fn(), dispatchEvent: vi.fn(), addListener: vi.fn(), removeListener: vi.fn() };
      }),
      writable: true,
      configurable: true,
    });
