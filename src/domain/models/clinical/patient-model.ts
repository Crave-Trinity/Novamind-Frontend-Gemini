...
export function isPatientDemographics(
  value: unknown,
): value is PatientDemographics {
...
export function isTreatmentResponse(
  value: unknown,
): value is TreatmentResponse {
  if (!value || typeof value !== "object") return false;
