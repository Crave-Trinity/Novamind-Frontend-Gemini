...
const mockComponents = {
  ...
  ConnectionLine: ({ source, target, strength }: any) => (
    <div
      data-testid={`mock-connection-${source}-${target}`}
  ...
  ChevronDown: () => (
    <div data-testid="mock-icon-chevron-down">Chevron Down Icon</div>
  ),
  ChevronRight: () => (
    <div data-testid="mock-icon-chevron-right">Chevron Right Icon</div>
  ),
  ...
  TrendingUp: () => (
    <div data-testid="mock-icon-trending-up">Trending Up Icon</div>
  ),
  TrendingDown: () => (
    <div data-testid="mock-icon-trending-down">Trending Down Icon</div>
  ),
