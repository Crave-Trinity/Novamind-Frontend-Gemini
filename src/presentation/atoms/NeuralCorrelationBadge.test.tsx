...
describe("NeuralCorrelationBadge", () => {
  ...
  const mockLowCorrelation = {
    strength: 0.2,
    description:
      "Weak correlation between occipital activity and visual symptom",
  ...
  it("applies different color schemes based on correlation strength", () => {
    const { rerender } = render(
      <NeuralCorrelationBadge
        correlation={mockLowCorrelation}
        data-testid="badge"
      />,
    );
  ...
  it.skip("respects size prop with corresponding CSS classes", () => { // Skip
    ...
    rerender(
      <NeuralCorrelationBadge correlation={mockMediumCorrelation} size="md" />,
    );
    ...
    rerender(
      <NeuralCorrelationBadge correlation={mockMediumCorrelation} size="lg" />,
    );
