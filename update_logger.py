"""
Script to update the logger.py file with the proper implementation.
"""
...
logger_path = os.path.join('app', 'infrastructure', 'logging', 'logger.py')

# Write the content to the file
with open(logger_path, 'w') as f:
    f.write(logger_content)

print(f"Updated {logger_path} successfully!")